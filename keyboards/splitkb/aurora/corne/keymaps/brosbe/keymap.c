...
const uint16_t PROGMEM test_combo1[] = {KC_QUOT, KC_O, COMBO_END};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_split_3x6_3(
        ...
        KC_NO, KC_SLSH, KC_PSLS, LSFT(KC_PAST), KC_EXLM, KC_MINS,                           KC_QUOT, KC_LBRC, LSFT(KC_UNDS), KC_RBRC, KC_SLSH, KC_NO,
